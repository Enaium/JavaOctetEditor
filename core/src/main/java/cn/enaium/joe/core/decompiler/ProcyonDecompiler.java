...
public class ProcyonDecompiler extends AbstractDecompiler {
    public ProcyonDecompiler(JarModel jar, ConfigManager config, ClassNode classNode) {
    ...
    public String decompile() {
        ...
        decompilerSettings.getLanguage().decompileType(metadataSystem.lookupType(classNode.name).resolve(), new PlainTextOutput(stringwriter), new DecompilationOptions(){{
            ...
            settings.setJavaFormattingOptions(config.getByClass(ProcyonConfig.class).get());
