...
import cn.enaium.joe.core.task.SearchLdcTask
            ...
            top = MigPane("fillx", "[fill][fill]").apply {
                ...
                add(Button(i18n("menu.search")).apply {
                    setOnAction {
                        ...
                        task.submit(SearchLdcTask(jar, ldc.text)).thenAccept {
                            it.forEach { result ->
